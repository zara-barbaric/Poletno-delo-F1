...
for C in $(seq 0 0.5 20); do
	...
	if [[ -d "/scratch/barbariczara/2026/mg5/C_${wils}/pp_ca/C_${C}" ]]; then
		rm -r /scratch/barbariczara/2026/mg5/C_${wils}/pp_ca/C_${C}
	fi
...
output /scratch/barbariczara/2026/mg5/C_{wils}/pp_ca/C_${C}     
launch
0
