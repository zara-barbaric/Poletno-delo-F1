...
for pt in $(seq 5 5 500); do
	if [[ -d "/scratch/barbariczara/2026/mg5/C_${wils}/pp_c~a/meja_limit/C_${c}/pt_${pt}" ]]; then
		rm -r /scratch/barbariczara/2026/mg5/C_${wils}/pp_c~a/meja_limit/C_${c}/pt_${pt}
	fi
...
output /scratch/barbariczara/2026/mg5/C_${wils}/pp_c~a/meja_limit/C_${c}/pt_${pt}     
launch
0
