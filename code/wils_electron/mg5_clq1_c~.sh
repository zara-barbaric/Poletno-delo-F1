...
for C in $(seq 0 0.5 30); do
	if [[ -d "/scratch/barbariczara/2026/mg5/C_${wils}/pp_c~ee/C_${C}" ]]; then
		rm -r /scratch/barbariczara/2026/mg5/C_${wils}/pp_c~ee/C_${C}
	fi
    if [ "$C" = "0.0" ]; then
        C=0.01
    fi
...
output /scratch/barbariczara/2026/mg5/C_${wils}/pp_c~ee/C_${C}     
launch
0
